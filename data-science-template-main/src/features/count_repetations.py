...
fs = 1000/200 #5 instences per sec
...
column="acc_r"
LowPass.low_pass_filter(row_set,col=column,sampling_frequency=fs,cutoff_frequency=0.4,order=10)[column+"_lowpass"].plot()
...
def count_reps(dataset,cutoff=0.4,order=10,column="acc_r"):
    ...
    exercise = dataset["lable"].iloc[0].title()
